...
用法（registrar / app / auto_loop 的唯一入口）：
    ...
    from app.integrations.mail.providers import create_mail_provider, list_providers
...
from . import gmail          # noqa: F401,E402  kind="gmail" / "gmail_link"
from . import mailbox_url    # noqa: F401,E402  kind="mailbox_url"
