...
from app.webui.auto_loop import (
    AutoLoopController,
    _parse_proxy_pool,
    _phase_from_event,
    _proxy_session_key,
)
from app.webui import registrar
from app.sms_provider import _rotate_country_ids
...
class AutoLoopProxyTests(unittest.TestCase):
    ...
    def test_snapshot_reports_effective_concurrency_and_stuck_tasks(self):
        ...
        with mock.patch("app.webui.auto_loop.time.time", return_value=1100.0), \
                mock.patch("app.webui.auto_loop.db.stats", return_value={}):
